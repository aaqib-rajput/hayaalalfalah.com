...
import { AdminDataBootstrapper } from "@/components/admin/admin-data-bootstrapper"

const sidebarItems = [
  { name: "Dashboard", href: "/admin", icon: LayoutDashboard },
  { name: "Mosques", href: "/admin/mosques", icon: Building2 },
  { name: "Imams", href: "/admin/imams", icon: GraduationCap },
...
export default function AdminLayout({
  ...
  return (
    <ProtectedRoute allowedRoles={['MOSQUE_ADMIN', 'SUPER_ADMIN']}>
      <AdminDataBootstrapper />
