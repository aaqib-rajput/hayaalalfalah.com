      ...
      initialize: async () => {
        try {
          const [
            ...
            fetchApi<ShuraMemberCRUD[]>('/shura/members'),
            fetchApi<MosqueVisitCRUD[]>('/shura/visits'),
            fetchApi<ShuraMeetingCRUD[]>('/shura/meetings'),
            fetchApi<MosqueRegistrationCRUD[]>('/shura/registrations'),
            fetchApi<MosqueAssessmentCRUD[]>('/shura/assessments'),
            fetchApi<LectureCRUD[]>('/shura/lectures'),
            fetchApi<ImamAppointmentCRUD[]>('/shura/appointments'),
            fetchApi<MosqueCRUD[]>('/mosques'),
            fetchApi<ImamCandidateCRUD[]>('/shura/candidates'),
            fetchApi<ShuraTeamCRUD[]>('/shura/teams')
          ])
          ...
          console.error('Failed to initialize Shura store:', error)
        }
      }
    }),
    {
