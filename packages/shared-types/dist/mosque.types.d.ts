...
export type ManagementPosition = 'president' | 'vice_president' | 'secretary' | 'treasurer' | 'trustee' | 'board_member' | 'committee_head' | 'volunteer_coordinator' | 'education_director' | 'youth_director' | 'women_coordinator' | 'facilities_manager' | 'security_head' | 'other';
//# sourceMappingURL=mosque.types.d.ts.map